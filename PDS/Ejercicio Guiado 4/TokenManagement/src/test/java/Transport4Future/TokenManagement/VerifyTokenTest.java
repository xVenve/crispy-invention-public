...
class Verifytokentest 
{
	...
	void VerifyValidToken() throws Tokenmanagementexception 
	{
		...
		String tokenToVerify = "QWxnPUhTMjU2XG4gVHlwPVBEU1xuRGV2PTYzY2ZjZmQ3NDgwYTE2NmE1NDFhZWY2MDkyM2I5NjU5X"
				+ "G4gaWF0PTE4LTAzLTIwMjAgMTA6MjI6MjBcbiBleHA9MTYtMDQtMjAyMiAxODo1NTo0MDA2ODI4YTI2NzhlZ"
				+ "jYzNjc3OWJiMzVmZWFiZjI2Njg1OGU4NWFlYThjYjQ2YWQ1NDMyYWIwMTQzOTFmYjc0MTg=";
		boolean result = my_manager.VERIFY_TOKEN(tokenToVerify);
