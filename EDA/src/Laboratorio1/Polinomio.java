...
public class Polinomio implements iPolinomio {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Grado: " + a.getDegree() + " Coeficiente 1º: " + a.getCoeficient(1) + " Valor para x con valor 2: " + a.getValue(2));
        a.show();
        //a.setCoeficient(0, 5);
        System.out.println("Grado: " + b.getDegree() + " Coeficiente 1º: " + b.getCoeficient(1) + " Valor para x con valor 2: " + b.getValue(2));
        b.show();
        //b.setCoeficient(0, 5);
