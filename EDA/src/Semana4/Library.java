			...
			for(int i=1;i<size;i++) {
				...
				for(int j=0;j<size-i;j++) {
					...
					if(NodeIt.prev.elem.author.toLowerCase().charAt(0)>NodeIt.elem.author.toLowerCase().charAt(0)) {
						change=true;
					}else if(NodeIt.prev.elem.author.toLowerCase().charAt(0)==NodeIt.elem.author.toLowerCase().charAt(0)&&
							NodeIt.prev.elem.author.toLowerCase().charAt(1)>NodeIt.elem.author.toLowerCase().charAt(1)) {
						change=true;
					}
					if(change) {
