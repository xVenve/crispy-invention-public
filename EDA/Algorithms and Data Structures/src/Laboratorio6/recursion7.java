...
public class recursion7 {
	/**
	 * Método recursivo que toma un array de enteros y un entero y devuelve el
	 * índice de este entero en el array. Si el entero no existe en el array, el
	 * método devuelve -1.
	 *
	 * @param a Array en el que buscar el entero x
	 * @param x Valor del que deseamos conocer su posicion en el array
	 *
	 * @retun Indice del valor x en el array a. Y -1 si el array esta vacio o no se
	 *        ha encontrado
	 */
