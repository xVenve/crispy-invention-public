...
public class DListVertex implements IList {
  ...
  public void insertAt(int index, int v, float w) {
    ...
    for (
      DNodeVertex nodeIt = header;
      nodeIt != trailer && inserted == false;
      nodeIt = nodeIt.next
    ) {
      if (i == index) {
  ...
  public boolean contains(int vertex) {
    boolean found = false;
    for (
      DNodeVertex nodeIt = header.next;
      nodeIt != trailer && found == false;
      nodeIt = nodeIt.next
    ) {
  ...
  public String toString() {
    ...
    for (
      ...
      if (result == null) {
        result =
          String.valueOf(nodeIt.vertex) + ":" + String.valueOf(nodeIt.weight);
      } else {
        result +=
          "," +
          String.valueOf(nodeIt.vertex) +
          ":" +
          String.valueOf(nodeIt.weight);
      }
    }
