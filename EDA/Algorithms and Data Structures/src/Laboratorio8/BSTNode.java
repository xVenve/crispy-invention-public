...
public class BSTNode implements IBSTNode {
	...
	public int getDepth() {
		int depth = 0;
		// we need to define a variable node, that allows us to ascend through its
	...
	// Another recursive version using an auxiliary method I think that this is more
	...
	// a recursive version that does not use an auxiliary method I don't like it,
	// but it's right
	public int getSize2() {
		int result;
	...
	// return the height of the node (which is the longest path from the node to any
	// leaf)
	...
	public void showLevels() {
		// we define a queue of BSTNodes. Queue is an interface LinkedList is the
		// implementation Java allows us to create
	...
	public static void main(String args[]) {
		// We want to build the follow tree: 5 3 8 6 9 YOU SHOULD NEVER IMPLEMENT THIS
		// CODE!!! YOU SHOULD ALWAYS
