...
public class BinTree {
  ...
  public static int getDepth(BinTreeNode node) {
    if (node == null) return -1; else return 1 + getDepth(node.parent);
  }
  ...
  public void printGivenLevel(BinTreeNode root, int level) {
    if (root == null) return;
    if (level == 1) System.out.print(root.elem + " "); else if (level > 1) {
  ...
  public static void main(String args[]) {
    ...
    System.out.println(
      "the size of the first right node (C) " + getSize(right1)
    );
    ...
    System.out.println(
      "the height of the first left node (B) " + getSize(left1)
    );
    System.out.println(
      "the height of the first right node (C) " + getSize(right1)
    );
    System.out.println(
      "the height of the node with value F " + getSize(right22)
    );
    System.out.println();

    System.out.println(
      "the depth of the first left node (B) " + getDepth(left1)
    );
    System.out.println(
      "the depth of the first right node (C) " + getDepth(right1)
    );
    System.out.println(
      "the depth of the node with value F " + getDepth(right22)
    );
    System.out.println("the depth of the root " + getDepth(root));
    System.out.println();

    System.out.println(
      "the depth (iterative method) of the first left node (B) " +
      getDepthIt(left1)
    );
    System.out.println(
      "the depth (iterative method) of the first right node (C) " +
      getDepthIt(right1)
    );
    System.out.println(
      "the depth (iterative method) of the node with value F " +
      getDepthIt(right22)
    );
    System.out.println(
      "the depth (iterative method) of the root " + getDepthIt(root)
    );
    System.out.println();
    System.out.println(
      "PreOrder trasversal of the tree: " + tree.getPreorder().toString()
    );
    System.out.println(
      "InOrder trasversal of the tree: " + tree.getInOrder().toString()
    );
    System.out.println(
      "PostOrder trasversal of the tree: " + tree.getPostOrder().toString()
    );
    System.out.println();
