...
public class Ej4Avion {
	...
	public Ej4Avion(String numero, int asientos, String estado, Ej4Isla origen,
			Ej4Isla destino, String compania) {
		setNumero(numero);
		setAsientos(asientos);
		if(estado.equals("cancelado")|| estado.equals("puntual")|| estado.equals("retrasado")) {
