...
public class Ej2estudiante {
    ...
    public Ej2estudiante(String nombre, String apellido, double programacion, double algebra, double calculo, double fisica, double escritura, double informacion) {
