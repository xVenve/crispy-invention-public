...
public class Ej3Estudiante {
    ...
    public Ej3Estudiante(String nombre, String apellido, double programacion, double algebra, double calculo, double fisica, double escritura, double informacion) {
