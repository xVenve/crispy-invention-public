...
public class Ejercicio6 {
	public static void main(String[] args) {
		...
		if(aa>=bb) {
			if(aa>=cc) {
				if(aa==cc) {
					System.out.println("LOS GANADORES FINALES HAN SIDO EL JUGADOR 1 CON "+aa+" PUNTOS Y EL JUGADOR 3 CON "+cc+" PUNTOS");
				}else {
					if(aa==bb) {
						System.out.println("LOS GANADORES FINALES HAN SIDO EL JUGADOR 1 CON "+aa+" PUNTOS Y EL JUGADOR 2 CON "+bb+" PUNTOS");
					}else
			...
			if(bb>=cc) {
				if(bb==cc) {
					System.out.println("LOS GANADORES FINALES HAN SIDO EL JUGADOR 2 CON "+bb+" PUNTOS Y EL JUGADOR 3 CON "+cc+" PUNTOS");
				}else {
